########################################################################################################################
#!!
#! @description: This flow sets a maintenance of a server that is monitored by the Zabbix server. It contains a locking
#!               mechanism that prevents you from set simultaneously more maintenances with the same name.
#!
...
#! @input maintenance_name: The name of the maintenance to be created.
...
#!
#! @output period_for_maintenance_in_seconds: Generated description
...
#! @output active_since: Generated description
#! @output zabbix_host_id: Generated description
#! @output active_till: Generated description
#! @output failure_message: Generated description
#!
...
namespace: io.cloudslang.content.zabbix.maintenance
  ...
  workflow:
            ...
            - body: |
                  ...
                  "params": {
                      ...
                      "timeperiods": [
                          {
                              "timeperiod_type": 0,
                              "period": ' + period_for_maintenance_in_seconds + '}]},
                  "auth": "' + zabbix_token + '",
                  "id": 1}'
            - content_type: 'application/json-rpc'
            - auth_type: 'Basic'
    ...
    - get_zabbix_host_id:
        ...
        publish:
          ...
          - zabbix_host_id
        navigate:
          - SUCCESS: get_current_timestamp
          - FAILURE: set_failure_message

    - get_end_timestamp:
        do:
          get_end_timestamp:
            - value_1: ${periodForMaintenanceInSeconds}
            - value_2: ${activeSince}
            - operation: '+'
        publish:
          - active_till
        navigate:
          - DONE: create_zabbix_maintenance
    ...
    - set_success_message:
        do:
          utils.noop:
            - text: ${'Successfully created the maintenance "' + maintenance_name + '" for server "' + server_name + '".'}
        publish:
          - return_result: ${ text }
        navigate:
          - SUCCESS: SUCCESS
