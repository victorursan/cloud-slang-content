########################################################################################################################
#!!
#! @description: This flow removes a maintenance of a server that is monitored by the Zabbix server. It contains a
#!               locking mechanism that prevents you from unset simultaneously a maintenance.
#!
...
#! @input maintenance_name: The name of the maintenance to be removed.
...
#! @output zabbix_maintenance_id: Generated description
#!
...
flow:
  ...
  workflow:
    - get_zabbix_maintenance_id_json:
        do:
    ...
    - get_zabbix_maintenance_id:
        do:
          get_zabbix_maintenance_id:
            - object: ${jsonResponse}
            - specific_error: ${'Maintenance "' + maintenance_name + '" not found.'}
            - key: 'result[0].maintenanceid'
        publish:
          - zabbix_maintenance_id
          - return_result
        navigate:
          - SUCCESS: remove_zabbix_maintenance
          - FAILURE: set_failure_message
    ...
    - check_zabbix_response_1:
        ...
        publish:
          - return_result
        navigate:
          - SUCCESS: get_zabbix_maintenance_id
          - FAILURE: set_failure_message
    ...
    - set_success_message:
        do:
          utils.noop:
            - text: ${'Successfully removed maintenance "' + maintenance_name + '".'}
        publish:
          - return_result: ${ text }
        navigate:
          - SUCCESS: SUCCESS
